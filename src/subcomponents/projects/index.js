...
import {
  BuiltUsing,
  Container, ContributorName, Date,
  ...
  ListItemTitle, ProjectDescription, ProjectFrameworks,
  ProjectListContainer,
  ProjectsContentContainer,
  SubTitle, TagBubble, TagBubbleContainer,
  TimeLineContainer,
  Title
...
Projects.DescriptionHeader = function ProjectsDescriptionHeader({children, ...restProps}) {
  return <DescriptionHeader {...restProps}>{children}</DescriptionHeader>;
}

Projects.DescriptionContent = function ProjectsDescriptionContent({children, ...restProps}) {
  return <DescriptionContent {...restProps}>{children}</DescriptionContent>;
}

Projects.DescriptionHeaderImage = function ProjectsDescriptionHeaderImage({children, ...restProps}) {
  return <DescriptionHeaderImage {...restProps}>{children}</DescriptionHeaderImage>;
}

Projects.DescriptionHeaderContent = function ProjectsDescriptionHeaderContent({children, ...restProps}) {
  return <DescriptionHeaderContent {...restProps}>{children}</DescriptionHeaderContent>;
}

Projects.DescriptionTitle = function ProjectsDescriptionTitle({children, ...restProps}) {
  return <DescriptionTitle {...restProps}>{children}</DescriptionTitle>;
}

Projects.ContributorName = function ProjectsContributorName({children, ...restProps}) {
...
Projects.ProjectFrameworks = function ProjectsProjectFrameworks({children, ...restProps}) {
  return <ProjectFrameworks {...restProps}>{children}</ProjectFrameworks>;
}

Projects.TagBubbleContainer = function ProjectsTagBubbleContainer({children, ...restProps}) {
